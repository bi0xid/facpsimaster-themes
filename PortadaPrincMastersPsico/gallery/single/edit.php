...
<div id="gallery-notification"></div>
<?php
...
if(bp_is_gallery_edit_details()){?>
		...
		<form action="" method="post" id="gallery_edit_info">
			<div class='edit-gallery' id="gallery_<?php echo bp_get_gallery_id($gallery);?>">
                            ...
                            <div class='edit-info'>
                                <input type="text" id="gallery_title" name="gallery_title" value="<?php echo bp_get_gallery_title($gallery);?>">
				<br />
	...
	<form action="" method="post" id="media_bulk_edit_form">
	 <input type="submit" name="save" value="Save" />
	    <?php while(bp_gallery_medias()):bp_gallery_the_media() ;?>
			...
			<label><input type="radio" name="gallery_cover" value="<?php bp_media_id();?>" /> Set Cover</label>
			</div>
			<br class="clear" />
		     </div>
	<?php endwhile;	?>
